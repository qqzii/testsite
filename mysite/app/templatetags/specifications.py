...
PRODUCT_SPEC = {
    ...
    'monitor': {
        ...
        'Поверхность экрана': 'screen_surface',
        'Сенсорный экран': 'touch_screen',
        'Динамическая частота обновления экрана': 'dynamic_refresh_rate',
        'Технология синхронизации кадров': 'frame_sync_technology',
        'Яркость': 'brightness',
        'Контрастность': 'contrast',
        'Цветовой охват sRGB': 'srgb',
        'Цветовой охват DCI-P3': 'dci_p3',
        'Время отклика (GtG)': 'gtg',
        'Угол обзора по горизонтали': 'horizontal_viewing_angle',
        'Угол обзора по вертикали': 'vertical_viewing_angle',
        ...
        'Ethernet': 'ethernet',
        'Крепление VESA': 'vesa',
        'Поворот вправо-влево': 'turn_left_right',
        'Портретный режим': 'portrait_mode',
        'Максимальный угол наклона экрана': 'max_screen_tilt_angle',
        'Ширина': 'width',
        'Глубина': 'depth',
        'Высота': 'height',
        'Вес': 'weight'
    ...
    'loudspeaker': {
        'Дата выхода на рынок': 'market_date',
        'Тип': 'type',
        'Номинальная мощность (RMS)': 'rms',
        'Питание': 'supply',
        'Цвет': 'color',
        'Стереодинамики': 'stereo_speakers',
        'Панорамное аудио': 'panoramic_audio',
        'Количество полос': 'number_of_stripes',
        'Количество динамиков': 'number_of_speakers',
        'Количество пассивных динамиков': 'number_of_passive_speakers',
        'Акустическое оформление': 'acoustic_design',
        'Частотный диапазон': 'frequency_range',
        'Диаметр НЧ-динамика (вуфера)': 'woofer_diameter',
        'Диаметр СЧ-динамика': 'midrange_speaker_diameter',
        'Диаметр ВЧ-динамика (твитера)': 'tweeter_diameter',
        'Диаметр широкополосного динамика': 'speaker_diameter',
        'Материал корпуса': 'body_material',
        'Дисплей': 'display',
        'Голосовой ассистент': 'voice_assistant',
        'Стриминговые сервисы': 'streaming_services',
        'Поддержка аудиокодеков Bluetooth': 'audio_codec_support',
        'Синхронизация': 'sync',
